...
public class CidCheckOutData {
    ...
    private List<ShelvesCheckOutData> shelves;   //货道销量与累计数
    ...
    public List<ShelvesCheckOutData> getShelves() {
        return shelves;
    }

    public void setShelves(List<ShelvesCheckOutData> shelves) {
