 ...
 * @author shixj
 */
public class SiteStatisticBase {

    @Id
    @JsonProperty("_id")
    private ObjectId id;	              //唯一标识
    private ObjectId oid;	              //机构ID 
    private String siteId;                //现场ID
    ...
    public Long wechatAmount;            //微信金额
    public Long alipayAmount;            //支付宝金额
    private Double alipayCharge;           //支付宝手续费
    private Double wechatCharge;            //微信手续费
    public Long baifubaoAmount;          //百付宝金额
    public Long alipaySoundWaveAmount;   //支付宝声波支付金额
    public Long otherAmount;             //现金支付金额
    public Long swingCardAmount;               //刷卡金额
    public Long oneCardsolutionAmount;   //一卡通金额
    public Long agriculturalBankAmount;  //农行掌银支付金额
    public Long posMachineAmount;        // POS机支付金额
    public Long gameAmount;              //游戏抽奖金额
    public Long otherPayStyleAmount;     //其他支付方式金额(6 扫胸牌,7 取货码,8 游戏...)
    public Long vipPayAmount;            //会员支付金额
    public Long bestPayAmount;            //翼支付金额
    public Long jdpayAmount;            //京东支付金额
    public Long wechatBarcodeAmount;    //微信反扫金额
    public Long alipayBarcodeAmount;   //支付宝反扫金额
    
    
    public Long wechatSum;               //微信笔数
    public Long alipaySum;               //支付宝笔数
    public Long baifubaoSum;             //百付宝笔数
    public Long alipaySoundWaveSum;      //支付宝声波支付笔数
    public Long otherSum;                //现金笔数
    public Long swingCardSum;               //刷卡笔数
    public Long oneCardsolutionSum;       //一卡通笔数
    public Long agriculturalBankSum;      //农行掌银支付笔数
    public Long posMachineSum;            // POS机支付笔数
    public Long gameSum;                 //游戏抽奖笔数
    public Long otherPayStyleSum;         //其他支付方式笔数
    public Long vipPaySum;              //会员支付笔数
    public Long bestPaySum;              //翼支付笔数
    public Long jdpaySum;              //京东支付笔数
    ...
    public Long getData(String name,int type,SiteStatisticBase ss){
         ...
         try {
                Object temp = c.getField(namet).get(ss);
                if(temp != null){
                    res = (Long) temp;
                }
